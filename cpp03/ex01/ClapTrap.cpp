...
{
	std::cout << "constructor ClapTrap with name is called" << std::endl;
...
ClapTrap::~ClapTrap()
{
	std::cout << "destructor Claptrap of " << this->_name << " is called " << std::endl;
...
{
	std::cout << "Constructor Claptrap of recopy called for " << this->_name  << std::endl;
}
